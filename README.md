...
[1.Titanic](https://github.com/ajithsandilya/deep_learning/tree/master/Projects/titanic) project demonstates the use of machine learning to create a model that predicts which passengers survived the Titanic shipwreck.
